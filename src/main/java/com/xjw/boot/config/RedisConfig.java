...
import com.xjw.boot.config.properties.RedisConfigProperties;
...
/*        //hash  使用jdk  的序列化
        redisTemplate.setHashValueSerializer(fastJson2JsonRedisSerializernew JdkSerializationRedisSerializer());
